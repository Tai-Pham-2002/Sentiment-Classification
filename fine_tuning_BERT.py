...
if __name__ == "__main__":
    ...
    def split_dataset(csv_file, train_size=0.8, val_size=0.1, random_state=42):
    ...
    csv_train, csv_val, csv_test = split_dataset("IMDB Dataset.csv")
    ...
    # save model
    torch.save(model.state_dict(), "model_last_block.pt")